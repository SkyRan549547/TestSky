...
/**
 * AbstractTplTransStation entity provides the base persistence definition of
 * the TplTransStation entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTplTransStation implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTplTransStation() {
	}

	/** minimal constructor */
	public AbstractTplTransStation(Long id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractTplTransStation(Long id, String stationSeqId,
			String stationId, String stationName, String stationStatus,
			String transType, String privateLineId, String privateLineName,
